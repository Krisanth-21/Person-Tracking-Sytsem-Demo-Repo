        ...
        for encodeFace, faceloc in zip(encodeCurFrame, facesCurFrame):
            ...
            if matches[matchIndex]:
                ...
                if name not in registered_names:
                    ...
                    add_people = "INSERT INTO team_301 (Register_Number, barcode, Name, Face_Time, Barcode_Time) VALUES (%s, %s, %s, %s, %s)"
...
def download_attendance():
    ...
    cursor.execute("SELECT Register_Number, Name, Face_Time, Barcode_Time,Status FROM team_301")
